...
?>
  ...
  <div id="footer">
   <hr>
   <p>Theme By | IT Empire Technologies |&copy;2020-2022 All right reserved.
    <br><a style="color: white; text-decoration: none; cursor: pointer; font-weight:bold;" href="jazebakram.com/coupons"
     target="_blank">Build reponsive website with html5 and css from scratch.</a>
    <br><a style="color: white; text-decoration: none; cursor: pointer; font-weight:bold;" href="jazebakram.com/coupons"
     target="_blank">Javascript complete and comprehensive for beginners. </a>
    <br>CSS Animations & Design for UI UX Designers. finally the best course for moderen deigner is out. after previous
    skillfull courses.
